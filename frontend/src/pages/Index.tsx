...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      />
      {/* Page Header */}
      <header className="bg-gradient-to-r from-[#0059A0] to-[#004A85] border-b border-[#004A85]/50 py-5 px-6 sticky top-0 z-50 shadow-lg">
        <div className="max-w-[1800px] mx-auto flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tight text-white">Apontamento de Presença</h1>
              <p className="text-sm text-white/80 font-normal">Gestão de frequência de funcionários</p>
            </div>
          </div>
          <div className="flex items-center gap-2 flex-wrap">
            <Link
              to="/"
              className="text-sm bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-lg transition-all font-normal inline-flex items-center gap-2 backdrop-blur-sm"
            >
              ← Voltar ao Menu
            </Link>
            ...
            <div className="text-sm bg-white/20 px-4 py-2 rounded-lg inline-flex items-center gap-2.5 backdrop-blur-sm text-white">
